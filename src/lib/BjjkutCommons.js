  ...
  return (
    <AlurakutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        <h1 className="bjjkut-logo">BJJKUT</h1>
        ...
        <nav>
          ...
          <div>
            <input placeholder="Pesquisar no BJJkut" />
          </div>
        </nav>
...
AlurakutMenu.Wrapper = styled.header`
  width: 100%;
  background-color: rgb(35, 44, 255);
...
export function OrkutNostalgicIconSet(props) {
  return (
    <OrkutNostalgicIconSet.List>
      ...
      {[
        { name: 'Legal', slug: 'confiavel', icon: 'heart' },
        { name: 'Passador', slug: 'legal', icon: 'smile' },
        { name: 'Guardeiro', slug: 'sexy', icon: 'cool' },
      ].map(({ name, slug, icon }) => {
